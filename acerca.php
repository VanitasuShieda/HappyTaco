...
<body>
	...
	<span>
		<section class="container">
			...
			<div class="page-header" id="objetivo">
				...
				<div class="articleBody">
					<div>
						...
						<hr>
						<br>
						<div style="height: 2%; background: no-repeat center center scroll; background-image: url(img/bg-logo.jpg);">
						<br><br> 
						</div>
						<br>
						...
						<hr>
						<ul id="mision">
							<li><strong>Misión.</strong>
							<p style="text-align:justify"><img src="img/mision.jpg" style="float:right; margin-left:10px; margin-bottom:10px" border="0" width="530" height="309" /></p>
							</li><p style="text-align:justify">Lograr la completa satisfacción de las expectativas de todos nuestros clientes, trabajadores y accionistas.</p>
						</ul>
						
						<ul>
							<li><strong id="vision">Visión.</strong>
